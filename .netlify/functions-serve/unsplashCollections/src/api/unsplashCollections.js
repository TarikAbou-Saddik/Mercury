...
var createRequest = (url) => new Request(url, {
  headers: { Authorization: `Client-ID ${process.env.UNSPLASH_ACCESS_KEY}` }
});
var createResponse = (statusCode, jsonBody) => ({
  statusCode,
  body: JSON.stringify(jsonBody)
});
var handler = async (event, context) => {
  try {
    if (event.queryStringParameters && "collectionId" in event.queryStringParameters) {
...
//# sourceMappingURL=unsplashCollections.js.map
